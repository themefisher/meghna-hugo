...
bscols(widths = c(3,9),
       ...
       list(
        ...
        renderPlotly({
         ...
         if(class(x) == class(final_listings$price)) {
           plot_ly(type = 'box') %>%
...
bscols(widths = c(3,9),
       list(
        ...
        "Class type of y variable is  ",
         
         renderText({
          x <- unlist(final_listings[,input$y_var])
          class(y)
          }),
